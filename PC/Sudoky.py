...
class SudokuGUI:
            ...
            try:
                if self.ser.in_waiting > 0:
                    ...
                    while len(buffer) >= 6:
                        ...
                        # Повне поле (84 байти)
                        if cmd_type in [CMD_START, CMD_RESTART]:
    ...
    def create_menu(self):
        ...
        tk.Label(self.menu_frame, text="Оберіть рівень складності:", font=("Arial", 10), bg="#f1f2f6").pack(
            pady=(10, 5))
    ...
    def show_overlay(self):
        ...
        tk.Label(self.overlay, text="ЗВ'ЯЗОК ВТРАЧЕНО", font=("Arial", 26, "bold"), fg="#e74c3c", bg="#2c3e50").pack(
            expand=True)
